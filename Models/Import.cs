...
namespace Model {
    public static class Import {
        public static void DBImport () {
            new Customer (
                "Kaique Augusto Benedito da Paz", 
                Convert.ToDateTime ("14/02/1989"), 
                "940.073.426-36", 
                5
            );
            new Customer (
                "Joana Liz Assis",
                Convert.ToDateTime ("24/10/1995"),
                "011.692.914-65", 
                15
            );
            new Customer (
                "Pietro Hugo da Rocha",
                Convert.ToDateTime ("21/04/1988"),
                "278.544.066-85", 
                10
            );
            new Customer (
                "Kauê José Gabriel Ramos",
                Convert.ToDateTime ("02/10/1955"),
                "602.912.005-08", 
                20
            );
            new Customer (
                "Benício Breno da Mota",
                Convert.ToDateTime ("04/12/1982"),
                "519.336.908-10", 
                25
            );
