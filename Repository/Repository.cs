...
namespace Repository {
    ...
    {
        public static DBFake<Customer> Customers = new DBFake<Customer>();
        public static DBFake<HeavyVehicle> HeavyVehicles = new DBFake<HeavyVehicle>();
        public static DBFake<LightVehicle> LightVehicles = new DBFake<LightVehicle>();
        public static DBFake<Rent> Rents = new DBFake<Rent>();
        public static DBFake<RentHeavyVehicle> RentsHeavyVehicles = new DBFake<RentHeavyVehicle>();
        public static DBFake<RentLightVehicle> RentsLightVehicles = new DBFake<RentLightVehicle>();
        ...
        public Context() {
            ...
            JsonElement.ArrayEnumerator customers = readJson(@"customers.json");
            ...
            JsonElement.ArrayEnumerator heavyVehicles = readJson(@"heavyvehicles.json");
            ...
            JsonElement.ArrayEnumerator lightVehicles = readJson(@"lightvehicles.json");
            ...
            JsonElement.ArrayEnumerator rents = readJson(@"rents.json");
            ...
            JsonElement.ArrayEnumerator rentsHeavyVehicles = readJson(@"rentsheavyvehicles.json");
            ...
            JsonElement.ArrayEnumerator rentsLightVehicles = readJson(@"rentslightvehicles.json");
